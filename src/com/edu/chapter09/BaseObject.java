...
public abstract class BaseObject implements Serializable {
	...
	public BaseObject(Long objectId, boolean initializationRequired) {
		initialize(objectId, initializationRequired);
	}
	...
	private void initialize(Long objectId, boolean isRequired) {
		...
		if (objectId == null) {
			...
			BaseObject obj = MemoryManager.getInstance().lookUpInCurrentThread(objectId);
			if (obj == null) {
